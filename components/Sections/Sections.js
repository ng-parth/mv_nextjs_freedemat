    ...
    <div className="col-sm-12">
      <div className="card border-success text-end">
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-body">
              <h3 className="card-title">Want to Start Trading with zero knowledge & free of cost?</h3>
              <p className="card-text">Algorithmic trading, also known as algo trading, is becoming increasingly popular in the Indian stock market. It involves using computer programs and algorithms to automate trades based on pre-set rules and conditions. Algo trading can provide several benefits such as faster and more accurate trade execution, reduced emotional bias, and the ability to analyze large amounts of data quickly. However, it's important to note that algo trading also carries certain risks, such as technical glitches or market volatility. It's crucial for traders to have a thorough understanding of the algorithms being used and to continuously monitor and adjust their strategies. With the right approach and risk management, algo trading can provide a competitive edge and potentially higher returns in the Indian stock market.</p>
