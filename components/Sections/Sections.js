...
import { OPEN_DEMAT_LINK } from '../../services/constants';
                  ...
                  <div className="row g-0">
                    <div className="col-md-8">
                      <div className="card-body">
                        ...
                        <Link
                          href={s.ctaLink || '#'}
                          className={`btn text-white ${s.ctaBtnClass}`}
                        >
                          {s.cta}
                        </Link>
                      </div>
